document.querySelectorAll('.second, .third, .fourth').forEach(item => {
    item.addEventListener('mouseenter', () => {
        document.querySelector('.first').classList.add('hover-effect');
        document.querySelector('.apple-text').classList.add('text-effect');
        document.querySelector('.rate').classList.add('text-effect');
        document.querySelector('.description').classList.add('text-effect');
        document.querySelector('.buy').classList.add('text-effect');
        document.querySelector('.first-img').classList.add('img-effect');

    });

    item.addEventListener('mouseleave', () => {
        document.querySelector('.first').classList.remove('hover-effect');
        document.querySelector('.apple-text').classList.remove('text-effect');
        document.querySelector('.rate').classList.remove('text-effect');
        document.querySelector('.description').classList.remove('text-effect');
        document.querySelector('.buy').classList.remove('text-effect');
        document.querySelector('.first-img').classList.remove('img-effect');
